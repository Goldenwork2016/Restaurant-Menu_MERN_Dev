				...
				<div class="row align-items-center justify-content-between">
					...
					<div class="col-xl-6 col-lg-6 d-flex flex-wrap align-items-center justify-content-right flex-direction-row-reverse zi-1000">
                        ...
                        <div class="checkout_mobile bg-modal type1">
                            ...
                            { (this.props.spaceStatus !=='Full') && <Elements>
                            <CheckoutFieldsForm
                                handleCheckout={this.handleCheckout} 
                                amount={this.props.onHomePage ? MONTHLY_MEMBERSHIP_PRICE:  this.props.amount}
                                currency={this.props.onHomePage ?'CAD' : this.props.currency}
                                productName={this.props.onHomePage ? 'HOMEPAGE' : this.props.productName}
                                productType={this.props.onHomePage ? 'HOMEPAGE' : this.props.productType}
                                type={this.props.onHomePage ? 'HOMEPAGE' : this.props.productType}
                                skuid={this.props.onHomePage ? 'HOMEPAGE' : this.props.skuid}
                                quantity={this.props.onHomePage ? 1 : this.props.quantity}
                                prodid={this.props.onHomePage ? 'HOMEPAGE' : this.props.prodid}
                                // coupon={this.props.coupon}
                                handleAppleGooglePay={this.handleAppleGooglePay}
                                skuQuantity={this.props.onHomePage ? 1 : this.props.skuQuantity}
                                onHomePage = {this.props.onHomePage}
                                skuData = {this.props.skuData? this.props.skuData : ''}
                                themeColor={this.props.themeColor}
                            />
                            </Elements>}
                            { (this.props.spaceStatus !=='Full' || this.props.onHomePage) && loading && <CheckoutLoading/>}
                            { ( (this.props.spaceStatus !=='Full' || this.props.onHomePage) && payment===true && orderid) && <PaymentSuccess
                            orderid={orderid}
                            />}
                            { ( (this.props.spaceStatus !=='Full' || this.props.onHomePage) && member===true && payment===false) && 
                            <MemberMsg
                            memberExists={member}
                            />}
                            {( (this.props.spaceStatus !=='Full' || this.props.onHomePage) && member===false && payment===false) && <PaymentFailure
                            />}
                            { (this.props.spaceStatus !=='Full') && (this.props.productType ==='subscription') && payment===null && !loading && 
                            ...
                            { (this.props.spaceStatus !=='Full' || this.props.onHomePage) && (productType ==='private') && payment===null && !loading && 
                        ...
                        <button id="btn" value="Copy link" onClick={copyMe()} class="color-white btn action-custom md color-white radius8 px-20 f-20 text-adaptive js-copy-btn" style={{color:this.props.themeColor}}>
