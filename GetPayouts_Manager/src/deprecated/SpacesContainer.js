...
export default class SpacesContainer extends React.Component {
    renderCards=()=>{
        ...
        .map((cardInfo) =>{
          return cardInfo.product_type==='spaces' && cardInfo.space_status==='Available' &&
          <Card
          key={cardInfo.sku_id}
      ...
      renderFullCards=()=>{
        ...
        .sort((a, b) => parseInt(a.activity_date_epoch) - parseInt(b.activity_date_epoch))
        .map((cardInfo) =>{
          return cardInfo.product_type==='spaces' && cardInfo.space_status==='Full' &&
          <Card
          key={cardInfo.sku_id}
          productName={cardInfo.product_name}
          price={cardInfo.sku_price}
      ...
      renderSoonCards=()=>{
        ...
        .sort((a, b) => parseInt(a.activity_date_epoch) - parseInt(b.activity_date_epoch))
        .map((cardInfo) =>{
          return cardInfo.product_type==='spaces' && cardInfo.space_status==='Soon' &&
          <CardSoon
          key={cardInfo.sku_id}
          productName={cardInfo.product_name}
          price={cardInfo.sku_price}
            ...
            <li className="LandingPage__section__1ZxoF" id="locations">
                <div className="LandingPage__sectionContentNarrow__3WnPV LandingPage__sectionContent__2emkg LandingPage__premiumListingWrapper__3ZrH3" id="locations">
                    ...
                    <h2 className="LandingPage__sectionTitle__kBCVT LandingPage__premiumListingsTitle__3PcWu mariapro">
                            <span>Shared workspaces near you</span>
                    </h2>
                    <p className="LandingPage__premiumListingsSubtitle__eos5d">
                            <span>Find beautiful workspaces nearby</span>
                    </p>
