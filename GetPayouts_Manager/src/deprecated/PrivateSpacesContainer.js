...
export default class PrivateSpacesContainer extends React.Component {
    renderCards=()=>{
        const {skuData} = this.props
        const cards = skuData
        .sort((a, b) => parseInt(a.activity_date_epoch) - parseInt(b.activity_date_epoch))
        .map((cardInfo) =>{
          return cardInfo.product_type==='private' && cardInfo.space_status==='Available' &&
          <Card
          key={cardInfo.sku_id}
      ...
      renderFullCards=()=>{
        ...
        .sort((a, b) => parseInt(a.activity_date_epoch) - parseInt(b.activity_date_epoch))
        .map((cardInfo) =>{
          return cardInfo.product_type==='private' && cardInfo.space_status==='Full' &&
          <Card
          key={cardInfo.sku_id}
          productName={cardInfo.product_name}
          price={cardInfo.sku_price}
      ...
      renderSoonCards=()=>{
        ...
        .sort((a, b) => parseInt(a.activity_date_epoch) - parseInt(b.activity_date_epoch))
        .map((cardInfo) =>{
          return cardInfo.product_type==='private' && cardInfo.space_status==='Soon' &&
          <CardSoon
          key={cardInfo.sku_id}
          productName={cardInfo.product_name}
          price={cardInfo.sku_price}
    ...
    render(){
        return(
            <li className="LandingPage__section__1ZxoF" id="locations">
                <div className="LandingPage__sectionContentNarrow__3WnPV LandingPage__sectionContent__2emkg LandingPage__premiumListingWrapper__3ZrH3" id="locations">
                    <div>
                    <h2 className="LandingPage__sectionTitle__kBCVT LandingPage__premiumListingsTitle__3PcWu mariapro">
                            <span>Daily private workspaces near you</span>
                    </h2>
                    <p className="LandingPage__premiumListingsSubtitle__eos5d">
                            <span>Find fully private workspaces nearby</span>
                    </p>
                    <div className="LandingPage__premiumListings__1N3tq">
                        {this.renderCards()} {this.renderFullCards()} {this.renderSoonCards()}
                            ...
                            <div className="ListingCard__threeToTwoWrapper__KPJGV">
                                ...
                                <picture>
                                    ...
                                    <source
                                        ...
                                        alt="Payouts listing"
                                        type="image/jpg" />
                                    <img src={process.env.PUBLIC_URL+"/assets/respaced-collaborate.jpg"} alt="Payouts listing"
