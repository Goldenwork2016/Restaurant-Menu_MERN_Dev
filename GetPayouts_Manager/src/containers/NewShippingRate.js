                            ...
                            <div class="container">
                                ...
                                <div class="col-12">
                                    ...
                                    <div class="row justify-content-center">
                                        ...
                                        <label>Shipping Rate Title</label>
                                        <div class="input-group">
                                            <input type="text" name="firstname" placeholder="Express Shipping"
                                            class="form-control border border-dark-3" required="required"/>
                                        </div>
                                        </div>
                                        <div class="mb-6 col-6">
                                        <label>Shipping Rate ID</label>
                                        <div class="input-group">
                                            <input type="text" name="lastname" placeholder="sr_i0hidfahkkljklj129"
                                    ...
                                    <div class="row justify-content-center">
                                        <div class="mb-6 col-6">
                                        <label>Minimum Shipping Time</label>
                                        <div class="input-group">
                                            <input type="text" name="firstname" placeholder="1 business day"
                                            class="form-control border border-dark-3" required="required"/>
                                        </div>
                                        </div>
                                        <div class="mb-6 col-6">
                                        <label>Maximum Shipping Time</label>
                                        <div class="input-group">
                                            <input type="text" name="lastname" placeholder="5 business days"
                                            class="form-control border border-dark-3" required="required"/>
                                        </div>
                                        </div>
                                    </div>
                                    <div class="row justify-content-center">
                                        ...
                                        <label>Shipping Rate Status</label>
                                        <div class="input-group">
