                                ...
                                <div class="col-12">
                                    ...
                                    <div class="row justify-content-center">
                                        ...
                                        <div class="input-group">
                                            <input type="text" name="firstname" placeholder="Christmas Special"
                                        ...
                                        <div class="input-group">
                                            <input type="text" name="lastname" placeholder="cp-329fjsaj77h338"
                                    ...
                                    <div class="row justify-content-center">
                                        ...
                                        <label>Type</label>
                                            <div class="ml-4 pt-5 row">
                                                ...
                                                <label for="vehicle1">Percentage Discount</label>
                                            </div>
                                            <div class="ml-4 pt-5 row">
                                                <input class="form-check-input" type="checkbox" id="vehicle1" name="vehicle1" value="Bike"/>
                                                <label for="vehicle1">Fixed Amount Discount</label>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row justify-content-center">
                                        ...
                                        <div class="input-group">
                                            <input type="text" name="firstname" placeholder="10%"
                                            class="form-control border border-dark-3" required="required"/>
                                        </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row justify-content-center">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <div class="pt-5 row">
                                                {/* <input class="form-check-input" type="checkbox" id="vehicle1" name="vehicle1" value="Bike"/> */}
                                                <label for="vehicle1">Defaults to unlimited if not specified</label>
                                            </div>
                                        </div>
                                    </div>
