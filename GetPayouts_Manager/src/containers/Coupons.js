...
const DashboardContainer = (props) => {
  ...
  // }
      ...
      const coupons_data_arr = merchant_coupons.data;
                    ...
                    <div class="col-sm-12 col-lg-12 col-md-12 col-xl-9">
                        <div class="row">
                            <section class="bg-bg-3 pt-10 pt-md-0">
                                ...
                                <p class="mb-5">
                                View all coupons and create new ones
                                </p>
                                {/* <div class="mb-6 col-lg-6" data-aos="fade-down" data-aos-delay="150">
                                 ...
                                 <a class="col-12" href="/new-coupon">
                                ...
                                {coupons_data_arr
                                && coupons_data_arr.length!==0
                                && coupons_data_arr.map(coupon=>
                                <Link class="contents" 
                                // to="/new-coupon"
                                >
                                <div class="mb-6 col-lg-6" data-aos="fade-down" data-aos-delay="150">
                                    <div class="border rounded-2 overflow-hidden btn-outline-action-10">
                                        <div class="row">
                                            <div class="col py-8 px-9">
                                                <div class="row justify-content-between">
                                                    ...
                                                    <div class="col-auto col-lg-12 col-xl-auto">
                                                        <p
                                                            ...
                                                            {coupon.amount_off ? `${(coupon.amount_off/100)}$` : `${coupon.percent_off}%`} off
                                                        </p>
                                                    </div>
                                                </div>
                                                ...
                                                {/* <p class="mb-0">
                                                    {'Christmas Special ( is this description ? may be we should add metadata description'}
                                                </p> */}
                                            </div>
                                        </div>
                                    </div>
