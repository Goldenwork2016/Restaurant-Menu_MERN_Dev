                  ...
                  <section class="bg-bg-3 pt-10 pt-md-0">
                    <div class="container">
                      <div class="row">
                        ...
                        <p class="mb-5">
                        You'll need to provide this information to start selling products and receiving payouts.
                        </p>
                        <form action="form-handler.php" method="post" enctype="multipart/form-data" class="js-ajax-form">
                          ...
                          <div class="row justify-content-center">
                            <div class="mb-6 col-lg-4 col-md-12">
                              <div class="input-group">
                          ...
                          <button class="btn btn-action-1 mt-4 mb-6">
                            Update Information
                          </button>
