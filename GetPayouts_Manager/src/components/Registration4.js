          ...
          <div class="container">
              <div class="row justify-content-between flex-row-reverse">
                  ...
                  <div class="col-4 col-sm-12 text-center">
                        <div class="pt-10">
                                <img src="../../assets/person4.png" alt="" class="illustration"/>
                        </div>
                    </div>
                  <div class="col-1"></div>
                  <div class="col-4 py-10 py-lg-20 col-xl-4 col-lg-5 col-md-6 col-sm-12">
                      ...
                      <p class="mb-8">
                          We need this information to deposit funds into your bank account
                      </p>
                      <section class="bg-bg-3 pt-10 pt-md-0">
                        <form action="form-handler.php" method="post" enctype="multipart/form-data" class="js-ajax-form">
                          ...
                          <div class="row justify-content-center">
                            <div class="mb-6 col-lg-12 col-md-12">
                              <div class="input-group">
                                <input type="text" name="lastname" placeholder="Bank Transit Number"
                                  class="form-control border border-dark-3" required="required"/>
                              </div>
                            </div>
                            <div class="mb-6 col-lg-12 col-md-12">
                              <div class="input-group">
                                <input type="text" name="firstname" placeholder="Bank Institution Number"
                                  class="form-control border border-dark-3" required="required"/>
                              </div>
                            </div>
                            <div class="mb-6 col-lg-12 col-md-12">
                              <div class="input-group">
                                <input type="text" name="lastname" placeholder="Bank Account Number"
                                  class="form-control border border-dark-3" required="required"/>
                              </div>
                            </div>
                          </div>
                          ...
                          <a href="/" class="btn btn-action-1 mt-4 mb-6 w-100">
