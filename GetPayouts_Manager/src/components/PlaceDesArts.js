...
import PlaceDesArtsContainer from '../containers/PlaceDesArtsContainer'

class PlaceDesArts extends React.Component  {
...
export default connect(mapStateToProps)(PlaceDesArts);
