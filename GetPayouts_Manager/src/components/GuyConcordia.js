...
import GuyConcordiaContainer from '../containers/GuyConcordiaContainer'

class GuyConcordia extends React.Component  {
...
export default connect(mapStateToProps)(GuyConcordia);
